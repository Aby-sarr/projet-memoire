...
DETAIL_OUTPUT = (
    Path("saved_models")
    / "errors_analysis_current.csv"
)

SUMMARY_OUTPUT = (
    Path("saved_models")
    / "error_categories_current.csv"
)
...
def contains_duplication(expected, predicted):
    ...
    # Recherche d'un caractère répété dans la prédiction
    if re.search(
        r"(.)\1",
        predicted
    ):
...
def classify_error(expected, predicted):
    ...
    # --------------------------------------------------------
    # 1. DIFFERENCE DE MAJUSCULE / MINUSCULE
    # --------------------------------------------------------
    ...
    # --------------------------------------------------------
    # 2. DIFFERENCE D'ACCENT / DIACRITIQUE
    # --------------------------------------------------------
...
print("=" * 60)
print("ANALYSE DES ERREURS - LATIN -> AJAMI")
print("=" * 60)

print()
print("Fichier :", ERROR_FILE)
...
if not ERROR_FILE.exists():
    ...
    print(
        "Vérifie que test_errors.csv se trouve dans saved_models."
    )
...
# ============================================================
# COLONNES DU FICHIER test_errors.csv
# ============================================================

expected_column = "Ajami_attendu"
predicted_column = "Ajami_predit"
...
print()
print(
    "Colonne source Wolof :",
    "Wolof"
)

print(
    "Colonne attendue Ajami :",
    expected_column
)

print(
    "Colonne prédite Ajami :",
    predicted_column
)

# ============================================================
# ANALYSE DES 95 ERREURS
# ============================================================
